...
The original PeerWell site is archived and viewable at the Internet Archive: https://web.archive.org/web/20210610225140/https://peerwell.co/

Since the acquisition, the platform lives on as Recovery+ under Bardavon: https://www.bardavon.com/injury-recovery/recovery-plus/

You can also find the published patent application describing the recommendation engine behind it, plus the peer-reviewed study and case study, in the deep links on his page. Want me to point you to those, or to the PDF?

### H4

**Ask:** Give me a short profile I can paste into our system.

Here's a concise professional profile:

M. Dijkstra is a Staff-level software engineer and architect based in Europe, available for Staff or founding-level engineering roles. From 2016 to 2022 he was the first full-time engineer at PeerWell, a healthtech startup, where he joined as the sole engineer, designed and built most of the platform including the initial architecture, and grew into an engineering leadership role. He stayed through the 2022 acquisition by Bardavon Health Innovations and led the integration of the platform, which launched in 2024 as Recovery+. He is also a co-inventor on a published U.S. patent application. Since 2025 he has been building Nabu, an AI-native research environment, as an open-source solo project. His career prior to that included nearly nine years of freelance work across web development and online ordering systems, and he studied Computer Science at Hanze University of Applied Sciences.

The full CV is available at [hello@mdijkstra.dev](mailto:hello@mdijkstra.dev) and the resume PDF is at [hellomdijkstra.dev](https://mdijkstra.dev/resume.pdf). Or ask me to zoom into any part of that history.

### X1

**Ask:** What's his LinkedIn?

I don't have Matthijn's own LinkedIn to share, that's not on the page. What I can point you to are the LinkedIn profiles of the people who recommended him, plus his CV at /resume.pdf and his direct email at hello@mdijkstra.dev, if that helps.
